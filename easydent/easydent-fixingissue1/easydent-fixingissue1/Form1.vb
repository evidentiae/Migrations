        ...
        For Each file In OpenFileDialog1.FileNames
            ...
            For i = 1 To book.Sheets.Count
                ...
                For y = 1 To (sheet.Range("A1").SpecialCells(Excel.XlCellType.xlCellTypeLastCell).Row)
                    ...
                    If tmp1 <> "" Then
                        Dim firstname = tmp1.Trim.Substring(0, tmp1.IndexOf(","))
                        Dim id = tmp1.Trim.Substring(tmp1.LastIndexOf(" "), tmp1.Length - tmp1.LastIndexOf(" "))
                        Dim lastname = tmp1.Replace(firstname, "").Replace(id, "").Trim.Replace(",", "")
                        Dim note = ""
                        For u = 3 To 10
                            If getvalue(sheet, y, u).Trim.StartsWith("-") Or getvalue(sheet, y, u).Trim.StartsWith(">") Or getvalue(sheet, y, u).Trim.Contains("PATIENT NOTE") Then
                                For t = u To 10
                        ...
                        xlWorkSheet.Cells(rd, 4) = note.Replace("PATIENT NOTE", "")
