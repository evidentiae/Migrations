        ...
        For Each file In OpenFileDialog1.FileNames
            ...
            For i = 1 To book.Sheets.Count
                ...
                For y = 1 To (sheet.Range("A1").SpecialCells(Excel.XlCellType.xlCellTypeLastCell).Row)
                    ...
                    If getvalue(sheet, y, 1).Contains(keyword) Then
                        xlWorkSheet.Cells(rd, 1) = (getvalue(sheet, y, 1) & getvalue(sheet, y, 2)).Replace(keyword, "").Replace(endword1, "").Replace(endword2, "")
                        rd = rd + 1
                    ElseIf getvalue(sheet, y, 2).Contains(keyword) Then
                        xlWorkSheet.Cells(rd, 1) = (getvalue(sheet, y, 2) & getvalue(sheet, y, 3)).Replace(keyword, "").Replace(endword1, "").Replace(endword2, "")
                        rd = rd + 1
                    End If
            ...
            xlWorkBook.SaveAs("C:\Users\developer\Desktop\bew\tmp\bew7.xlsx", Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue,
        ...
        For Each file In OpenFileDialog1.FileNames
            ...
            For i = 1 To book.Sheets.Count
                ...
                For y = 1 To (sheet.Range("A1").SpecialCells(Excel.XlCellType.xlCellTypeLastCell).Row)
                    ...
                    If getvalue(sheet, y, 1).Contains(keyword) Then
                        If getvalue(sheet, y - 2, 3).Contains("(W)") Then
                            xlWorkSheet.Cells(rd, 1) = " "
                            rd = rd + 1
                        Else
                            xlWorkSheet.Cells(rd, 1) = (getvalue(sheet, y - 2, 1) & getvalue(sheet, y - 2, 2)).Replace(keyword, "").Replace(endword1, "").Replace(endword2, "")
                            rd = rd + 1
                        End If
                    ...
                    ElseIf getvalue(sheet, y, 2).Contains(keyword) Then
                        If getvalue(sheet, y - 2, 3).Contains("(W)") Then
                            ...
                            rd = rd + 1
                        Else
                            xlWorkSheet.Cells(rd, 1) = (getvalue(sheet, y - 2, 2) & getvalue(sheet, y - 2, 3)).Replace(keyword, "").Replace(endword1, "").Replace(endword2, "")
                            rd = rd + 1
                        End If
                    End If
