                            ...
                            If Not starting = 0 Then
                                ...
                                If sd.Length > 1 Then
                                    If sd(1).Length > 1 Then
                                        ...
                                        If getvalue(sheet, y, starting + 2).Trim = "" Then
                                            xlWorkSheet.Cells(rd, 6) = getvalue(sheet, y, starting + 3)
                                            xlWorkSheet.Cells(rd, 7) = getvalue(sheet, y, starting + 4)
                                        End If



                                        If sd(1).Contains("Prim Dental") Then
                                            MsgBox(rd)
                                            xlWorkSheet.Cells(rd, 5) = sd(1).Replace("Prim Dental", "")
                                            xlWorkSheet.Cells(rd, 6) = "Prim Dental"
                                            xlWorkSheet.Cells(rd, 7) = getvalue(sheet, y, starting + 5)
                                        End If
                                        If sd(1).Contains("Sec Dental") Then
                                            xlWorkSheet.Cells(rd, 5) = sd(1).Replace("Sec Dental", "")
                                            xlWorkSheet.Cells(rd, 6) = "Sec Dental"
                                            xlWorkSheet.Cells(rd, 7) = getvalue(sheet, y, starting + 5)
                                        End If
                                    End If
